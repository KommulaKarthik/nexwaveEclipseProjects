...
public class TicketInfo {
	...
	public String toString() {
		return "TicketInfo [infoId=" + infoId + ", customerDetail=" + customerDetail + ", bookingDetail="
				+ bookingDetail + ", bookingMapDetail=" + bookingMapDetail + ", identityDetail=" + identityDetail
