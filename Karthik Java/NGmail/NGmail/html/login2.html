...
<form action="/gmail/LoginController" method="post" onsubmit="return validate();">
<table border="0">
...
<input type="password" name="password"  class="makeblack makewhite" id="password" placeholder="Enter Password">
</td></tr>
