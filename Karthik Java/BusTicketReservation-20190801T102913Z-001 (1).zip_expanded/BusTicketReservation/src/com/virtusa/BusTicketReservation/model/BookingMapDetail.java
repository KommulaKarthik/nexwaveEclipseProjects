...
public class BookingMapDetail {
	...
	public BookingMapDetail(int seatNumber, String travellerName, int travellerAge) {
		super();
		this.seatNumber = seatNumber;
		this.travellerName = travellerName;
		this.travellerAge = travellerAge;
	...
	public boolean equals(Object obj) {
		...
		if (bookingDetail == null) {
			...
			if (!bookingDetail.equals(other.bookingDetail))
			return false;
		...
		if (travellerName == null) {
			...
			if (!travellerName.equals(other.travellerName))
			return false;
		return true;
	}
