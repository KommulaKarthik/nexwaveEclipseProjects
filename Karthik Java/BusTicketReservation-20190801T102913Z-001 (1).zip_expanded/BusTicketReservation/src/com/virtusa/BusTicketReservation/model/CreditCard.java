...
public class CreditCard {
	...
	public CreditCard(int creditCardNumber, String creditCardHolderName, int cvvNumber, String expiryDate) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (creditCardHolderName == null) {
			...
			if (!creditCardHolderName.equals(other.creditCardHolderName))
			return false;
